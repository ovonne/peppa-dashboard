...
const SIDEBAR_WIDTH = "8.8rem";
const SIDEBAR_WIDTH_MOBILE = "8.8rem";
const SIDEBAR_WIDTH_ICON = "2rem";
const SIDEBAR_KEYBOARD_SHORTCUT = "b";
const SIDEBAR_PADDING = "1.6rem";
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      className={cn(
        "h-[4rem] w-[4rem] rounded-[1.2rem] bg-highlighted/10 p-[0.4rem] text-[1.4rem] text-highlighted hover:bg-highlighted/20 hover:text-highlighted",
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
